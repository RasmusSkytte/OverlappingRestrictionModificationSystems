...
xa = -0.085  # X coord of the annotaiton
y0 = -0.35
...
ax_annotate.text(xa,  y0+1.0,  'D / β',    verticalalignment = 'center', horizontalalignment = 'left', rotation = 90, color='b')
...
fig_path = os.path.join(get_path(), 'Figure_S14')
make_dirs(fig_path)
fig.savefig(os.path.join(fig_path, 'figS14.png'), bbox_inches = 'tight')