function [B, P, B_end, P_end, D_end, bacteria, phages, diversity, mRM, cost, omega_0, B_samples, overlap, age] = simulateExtendedModel(Alpha, Beta, Eta, Delta, C, T, S, RM, f, lb, ub, iterations, sname, varargin)
...
for i = 1:iterations
    ...
    if mod(i, 100) == 0
        save(sname, 'B', 'bacteria', 'phages', 'diversity', 'overlap', 'mRM', 'cost', 'omega_0', 'age', 'B_samples', 'C', 'Alpha', 'Beta', 'Delta', 'T', 'lb', 'ub', 'S', 'f', 'iterations', 'pertubation', 'sampleTimes')
    end
