function [B_end, P_end, D_end, bacteria, phages, diversity, mRM, gamma, omega, B_samples, nRM, age] = simulateOriginalModel(Alpha, Beta, Eta, Delta, C, T, S, f, lb, ub, iterations, sname, varargin)
...
for i = 1:iterations
    ...
    if mod(i, 100) == 0
        save(sname, 'bacteria', 'phages', 'diversity', 'mRM', 'nRM', 'gamma', 'omega', 'age', 'B_samples', 'C', 'Alpha', 'Beta', 'Delta', 'T', 'lb', 'ub', 'S', 'f', 'iterations', 'sampleTimes')
    end
end
